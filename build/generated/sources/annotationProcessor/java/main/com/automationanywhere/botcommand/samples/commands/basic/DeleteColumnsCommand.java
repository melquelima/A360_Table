...
public final class DeleteColumnsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DeleteColumnsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    DeleteColumns command = new DeleteColumns();
