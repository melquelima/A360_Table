...
import com.automationanywhere.botcommand.samples.commands.basic.SetColumnName;
import org.testng.annotations.Test;

import java.util.ArrayList;
import java.util.List;

public class SetColumnNameTest {
    @Test
    public void teste(){
        SetColumnName a = new SetColumnName();
        Table tb = this.tabela();


        TableValue ret = a.action(tb,"index","USD",0.0,"HEHE");

        System.out.println("==================" + ret.get().getSchema().get(0).getName() + " - " +  tb.getSchema().get(0).getName());
    }
